...
input.addEventListener("input", _lodashDebounceDefault.default((e)=>{
    inputValue(e);
}, DEBOUNCE_DELAY));
function inputValue(e) {
    const valueInput = e.target.value.trim();
    if (valueInput !== "") fechCauntry(valueInput);
}
function fechCauntry(valueInput) {
    _fetchCountries.fetchCountries(valueInput).then((date)=>{
        makeCards(date);
    }).catch(()=>{
        console.log("Error");
    });
...
function makeInfo() {
    _notiflixDefault.default.Notify.info("Too many matches found. Please enter a more specific name.");
}
function makeError() {
    _notiflixDefault.default.Notify.failure("Oops, there is no country with that name");
}

},{"./css/styles.css":"1CY4s","./js/fetchCountries":"dKuy9","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5WWYd"}],"1CY4s":[function() {},{}],"dKuy9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequireabb0")
